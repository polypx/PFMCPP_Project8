...
int main()
{
    ...
    motorcycles.emplace_back("Frank");
    motorcycles.emplace_back("Margaret");
    motorcycles.emplace_back("Pierre");

    trucks.reserve(3);
    trucks.emplace_back("Sam");
    trucks.emplace_back("Fred");
